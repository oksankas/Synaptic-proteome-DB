...
dbname<-"synaptic.proteome_SR_20240708.db.sqlite"
recreate<-TRUE
```
...
brainReg.df <- read.table("BrainRegions.txt", sep = "\t", header = TRUE, stringsAsFactors = FALSE )
brp <- read.delim("BrainRegPapers.txt", sep = "\t", header = T, stringsAsFactors = FALSE)
...
```{r Specie.Region}
sbr <- read.delim("BrainRegionSpecie.txt", sep = "\t", header = TRUE, stringsAsFactors = FALSE)
...
## Papers
```{r prepare.papers}
papers<-read.delim("Paper_DB_summary_April21.txt",sep='\t',header = TRUE, stringsAsFactors = FALSE)
...
pmed <- read.csv("pubmed.data.full.csv", stringsAsFactors = FALSE)
...
### Genes table
```{r full.genes}
full <- read.delim("Full_DB_April21.txt", sep = "\t", header = T, stringsAsFactors = FALSE)
...
gene1<-read.delim("PSD_db_Oct20.txt",sep ='\t',header=TRUE, stringsAsFactors = FALSE)
...
gene2<-read.delim("Pres_DB_April21.txt",sep ='\t',header=TRUE, stringsAsFactors = FALSE)
...
gene3<-read.delim("Syn_DB_April21.txt",sep ='\t',header=TRUE, stringsAsFactors = FALSE)
...
# PPI
```{r load.ppi}
ppi.df<-read.delim("PPI_DB_April21.txt",sep = "\t", header = TRUE, stringsAsFactors = FALSE)
...
# GO
```{r load.GO}
bph <- read.csv("flatfile_Human_BP.csv", sep = "\t", header = FALSE)
bpm <- read.csv("flatfile_Mouse_BP.csv", sep = "\t", header = FALSE)
bpr <- read.csv("flatfile_Rat_BP.csv", sep = "\t", header = FALSE)
...
BP$Domain <- "BP"
cch <- read.csv("flatfile_Human_CC.csv", sep = "\t", header = FALSE)
ccm <- read.csv("flatfile_Mouse_CC.csv", sep = "\t", header = FALSE)
ccr <- read.csv("flatfile_Rat_CC.csv", sep = "\t", header = FALSE)
...
CC$Domain <- "CC"
mfh <- read.csv("flatfile_Human_MF.csv", sep = "\t", header = FALSE)
mfm <- read.csv("flatfile_Mouse_MF.csv", sep = "\t", header = FALSE)
mfr <- read.csv("flatfile_Rat_MF.csv", sep = "\t", header = FALSE)
