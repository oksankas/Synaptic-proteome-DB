...
mg4<-melt(gene4[,c(5:dim(gene4)[2])],id="id")
mg4<-mg4[mg4$value==1,]
mg4$locID=4
...
totGene<-rbind(mag1[,c("id","locID","pmid","taxId","methodId", 'BrainRegionID')],
               ...
               mag4[,c("id","locID","pmid","taxId","methodId", 'BrainRegionID')])
