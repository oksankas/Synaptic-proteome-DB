...
mut.asd.df <- unique(mut.asd[!is.na(mut.asd$GeneID), c("GeneID", "HDOID","Chr", "Position", "Variant","FunctionClass", "cDnaVariant", "ProteinVariant","Exon.Intron", "DENOVO", "SFARI", "ClinVar")])
mut.asd.df$ID <- 1:dim(mut.asd.df)[1]
mut.asd.df$EpilepsyGene <- 'FALSE'
mut.asd.df <- mut.asd.df[, c("ID","GeneID", "HDOID","Chr", "Position", "Variant","FunctionClass", "cDnaVariant", "ProteinVariant","Exon.Intron", "DENOVO", "SFARI", "EpilepsyGene","ClinVar")]
names(mut.asd.df) <- c("ID","GeneID", "HDOID","Chromosome", "Position", "Variant","FunctionClass", "cDNAvariant", "ProteinVariant","ExonIntron", "DENOVO", "SFARI","EpilepsyGene", "ClinVar")
```

## Epilepsy related mutation
...
mut.epi.df <- unique(mut.epi[!is.na(mut.epi$GeneID), c("GeneID", "HDOID","Chr", "Position", "Variant","FunctionClass", "cDnaVariant", "ProteinVariant","Exon.Intron", "Denovo", "EpilepsyGene", "ClinVar")])
mut.epi.df$ID <- 1:dim(mut.epi.df)[1]
mut.epi.df$SFARI <- 'FALSE'
mut.epi.df <- mut.epi.df[, c("ID","GeneID", "HDOID","Chr", "Position", "Variant","FunctionClass", "cDnaVariant", "ProteinVariant","Exon.Intron", "Denovo", "SFARI","EpilepsyGene", "ClinVar")]
names(mut.epi.df) <- c("ID","GeneID", "HDOID","Chromosome", "Position", "Variant","FunctionClass", "cDNAvariant", "ProteinVariant","ExonIntron", "DENOVO", "SFARI","EpilepsyGene", "ClinVar")
```
